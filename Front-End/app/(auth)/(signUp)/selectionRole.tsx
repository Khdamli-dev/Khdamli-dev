...
import {
  View, Text, SafeAreaView, ScrollView, KeyboardAvoidingView, Dimensions, TouchableOpacity
} from 'react-native';
            ...
            {/* Header Section */}
             <LinearGradient colors={['#2B524A', '#5EB4A2']} start={{ x: 1, y: 0 }} end={{ x: 0, y: 1 }} style={{ borderBottomLeftRadius: screenWidth * 0.1, borderBottomRightRadius: screenWidth * 0.1 }} className=' w-full mb-safe-offset-2 pt-6  pb-2  shadow-md shadow-black'>
              ...
              <View className='pl-6  pt-6 pb-16  shadow-md shadow-black'>
                <Text style={{ textShadowColor: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 5 }} className="my-4 text-5xl font-semibold text-white">Select Your</Text>
                <Text style={{ textShadowColor: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 5 }}  className="text-5xl font-semibold text-white ">Role</Text>
              </View>
              ...
              <TouchableOpacity 
                ...
                <View className="flex-row items-center px-0">
                  ...
                  <Text className="ml-2 text-sm font-semibold">
                    As A Worker You Can - Receiving And {"\n"}Managing Orders - Communicating With {"\n"}Clients - Managing Comments And Ratings
                  </Text>
                </View>
              </TouchableOpacity>

              {/* Clients Card */}
              <TouchableOpacity className="bg-white w-96 rounded-2xl shadow-lg p-6 ">
                <View className="flex items-center ">

                  <MaterialCommunityIcons name="account" size={70} color="#F8A100" className='' />
